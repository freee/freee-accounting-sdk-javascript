...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.AccountItemParams();
  });
  ...
  describe('AccountItemParams', function() {
    it('should create an instance of AccountItemParams', function() {
      // uncomment below and update the code to test AccountItemParams
      //var instance = new FreeeAccountingClient.AccountItemParams();
      //expect(instance).to.be.a(FreeeAccountingClient.AccountItemParams);
    });
