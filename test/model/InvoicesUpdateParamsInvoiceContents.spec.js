...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.InvoicesUpdateParamsInvoiceContents();
  });
  ...
  describe('InvoicesUpdateParamsInvoiceContents', function() {
    it('should create an instance of InvoicesUpdateParamsInvoiceContents', function() {
      // uncomment below and update the code to test InvoicesUpdateParamsInvoiceContents
      //var instance = new FreeeAccountingClient.InvoicesUpdateParamsInvoiceContents();
      //expect(instance).to.be.a(FreeeAccountingClient.InvoicesUpdateParamsInvoiceContents);
    });
