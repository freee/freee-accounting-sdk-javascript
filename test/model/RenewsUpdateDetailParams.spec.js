...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.RenewsUpdateDetailParams();
  });
  ...
  describe('RenewsUpdateDetailParams', function() {
    it('should create an instance of RenewsUpdateDetailParams', function() {
      // uncomment below and update the code to test RenewsUpdateDetailParams
      //var instance = new FreeeAccountingClient.RenewsUpdateDetailParams();
      //expect(instance).to.be.a(FreeeAccountingClient.RenewsUpdateDetailParams);
    });
