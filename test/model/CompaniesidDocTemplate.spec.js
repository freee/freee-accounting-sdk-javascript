...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.CompaniesidDocTemplate();
  });
  ...
  describe('CompaniesidDocTemplate', function() {
    it('should create an instance of CompaniesidDocTemplate', function() {
      // uncomment below and update the code to test CompaniesidDocTemplate
      //var instance = new FreeeAccountingClient.CompaniesidDocTemplate();
      //expect(instance).to.be.a(FreeeAccountingClient.CompaniesidDocTemplate);
    });
