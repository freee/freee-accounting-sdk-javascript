...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.Parameters();
  });
  ...
  describe('Parameters', function() {
    it('should create an instance of Parameters', function() {
      ...
      //var instance = new FreeeAccountingClient.Parameters();
      //expect(instance).to.be.a(FreeeAccountingClient.Parameters);
    });
