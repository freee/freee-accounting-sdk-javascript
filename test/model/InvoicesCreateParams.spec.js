...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.InvoicesCreateParams();
  });
  ...
  describe('InvoicesCreateParams', function() {
    it('should create an instance of InvoicesCreateParams', function() {
      // uncomment below and update the code to test InvoicesCreateParams
      //var instance = new FreeeAccountingClient.InvoicesCreateParams();
      //expect(instance).to.be.a(FreeeAccountingClient.InvoicesCreateParams);
    });
