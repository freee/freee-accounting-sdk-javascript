...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.SectionParams();
  });
  ...
  describe('SectionParams', function() {
    it('should create an instance of SectionParams', function() {
      // uncomment below and update the code to test SectionParams
      //var instance = new FreeeAccountingClient.SectionParams();
      //expect(instance).to.be.a(FreeeAccountingClient.SectionParams);
    });
