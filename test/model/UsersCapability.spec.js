...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.UsersCapability();
  });
  ...
  describe('UsersCapability', function() {
    it('should create an instance of UsersCapability', function() {
      // uncomment below and update the code to test UsersCapability
      //var instance = new FreeeAccountingClient.UsersCapability();
      //expect(instance).to.be.a(FreeeAccountingClient.UsersCapability);
    });
    ...
    it('should have the property destroy (base name: "destroy")', function() {
      // uncomment below and update the code to test the property destroy
      //var instance = new FreeeAccountingClient.UsersCapability();
      //expect(instance).to.be();
    });
