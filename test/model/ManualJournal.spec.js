...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.ManualJournal();
  });
  ...
  describe('ManualJournal', function() {
    it('should create an instance of ManualJournal', function() {
      ...
      //var instance = new FreeeAccountingClient.ManualJournal();
      //expect(instance).to.be.a(FreeeAccountingClient.ManualJournal);
    });
