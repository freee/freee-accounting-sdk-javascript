...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.DealsDetails();
  });
  ...
  describe('DealsDetails', function() {
    it('should create an instance of DealsDetails', function() {
      // uncomment below and update the code to test DealsDetails
      //var instance = new FreeeAccountingClient.DealsDetails();
      //expect(instance).to.be.a(FreeeAccountingClient.DealsDetails);
    });
