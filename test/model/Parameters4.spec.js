...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.Parameters4();
  });
  ...
  describe('Parameters4', function() {
    it('should create an instance of Parameters4', function() {
      // uncomment below and update the code to test Parameters4
      //var instance = new FreeeAccountingClient.Parameters4();
      //expect(instance).to.be.a(FreeeAccountingClient.Parameters4);
    });
