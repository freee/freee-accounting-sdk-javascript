...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.DealsRenewsDetails();
  });
  ...
  describe('DealsRenewsDetails', function() {
    it('should create an instance of DealsRenewsDetails', function() {
      // uncomment below and update the code to test DealsRenewsDetails
      //var instance = new FreeeAccountingClient.DealsRenewsDetails();
      //expect(instance).to.be.a(FreeeAccountingClient.DealsRenewsDetails);
    });
