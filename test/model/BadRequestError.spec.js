...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.BadRequestError();
  });
  ...
  describe('BadRequestError', function() {
    it('should create an instance of BadRequestError', function() {
      ...
      //var instance = new FreeeAccountingClient.BadRequestError();
      //expect(instance).to.be.a(FreeeAccountingClient.BadRequestError);
    });
