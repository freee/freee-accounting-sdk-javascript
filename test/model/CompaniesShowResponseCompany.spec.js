...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.CompaniesShowResponseCompany();
  });
  ...
  describe('CompaniesShowResponseCompany', function() {
    it('should create an instance of CompaniesShowResponseCompany', function() {
      // uncomment below and update the code to test CompaniesShowResponseCompany
      //var instance = new FreeeAccountingClient.CompaniesShowResponseCompany();
      //expect(instance).to.be.a(FreeeAccountingClient.CompaniesShowResponseCompany);
    });
