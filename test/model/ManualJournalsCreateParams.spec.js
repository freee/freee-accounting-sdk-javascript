...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.ManualJournalsCreateParams();
  });
  ...
  describe('ManualJournalsCreateParams', function() {
    it('should create an instance of ManualJournalsCreateParams', function() {
      // uncomment below and update the code to test ManualJournalsCreateParams
      //var instance = new FreeeAccountingClient.ManualJournalsCreateParams();
      //expect(instance).to.be.a(FreeeAccountingClient.ManualJournalsCreateParams);
    });
