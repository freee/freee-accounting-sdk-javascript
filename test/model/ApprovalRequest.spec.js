...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.ApprovalRequest();
  });
  ...
  describe('ApprovalRequest', function() {
    it('should create an instance of ApprovalRequest', function() {
      ...
      //var instance = new FreeeAccountingClient.ApprovalRequest();
      //expect(instance).to.be.a(FreeeAccountingClient.ApprovalRequest);
    });
    ...
    it('should have the property approverId (base name: "approver_id")', function() {
    ...
    it('should have the property requestItems (base name: "request_items")', function() {
