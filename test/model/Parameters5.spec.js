...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.Parameters5();
  });
  ...
  describe('Parameters5', function() {
    it('should create an instance of Parameters5', function() {
      // uncomment below and update the code to test Parameters5
      //var instance = new FreeeAccountingClient.Parameters5();
      //expect(instance).to.be.a(FreeeAccountingClient.Parameters5);
    });
