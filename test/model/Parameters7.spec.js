...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.Parameters7();
  });
  ...
  describe('Parameters7', function() {
    it('should create an instance of Parameters7', function() {
      // uncomment below and update the code to test Parameters7
      //var instance = new FreeeAccountingClient.Parameters7();
      //expect(instance).to.be.a(FreeeAccountingClient.Parameters7);
    });
