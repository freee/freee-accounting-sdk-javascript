...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.ManualJournalsUpdateParams();
  });
  ...
  describe('ManualJournalsUpdateParams', function() {
    it('should create an instance of ManualJournalsUpdateParams', function() {
      // uncomment below and update the code to test ManualJournalsUpdateParams
      //var instance = new FreeeAccountingClient.ManualJournalsUpdateParams();
      //expect(instance).to.be.a(FreeeAccountingClient.ManualJournalsUpdateParams);
    });
