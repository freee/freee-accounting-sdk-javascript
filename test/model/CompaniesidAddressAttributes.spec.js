...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.CompaniesidAddressAttributes();
  });
  ...
  describe('CompaniesidAddressAttributes', function() {
    it('should create an instance of CompaniesidAddressAttributes', function() {
      // uncomment below and update the code to test CompaniesidAddressAttributes
      //var instance = new FreeeAccountingClient.CompaniesidAddressAttributes();
      //expect(instance).to.be.a(FreeeAccountingClient.CompaniesidAddressAttributes);
    });
