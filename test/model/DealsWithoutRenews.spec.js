...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.DealsWithoutRenews();
  });
  ...
  describe('DealsWithoutRenews', function() {
    it('should create an instance of DealsWithoutRenews', function() {
      // uncomment below and update the code to test DealsWithoutRenews
      //var instance = new FreeeAccountingClient.DealsWithoutRenews();
      //expect(instance).to.be.a(FreeeAccountingClient.DealsWithoutRenews);
    });
