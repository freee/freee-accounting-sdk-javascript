...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.ManualJournalsUpdateParamsDetails();
  });
  ...
  describe('ManualJournalsUpdateParamsDetails', function() {
    it('should create an instance of ManualJournalsUpdateParamsDetails', function() {
      // uncomment below and update the code to test ManualJournalsUpdateParamsDetails
      //var instance = new FreeeAccountingClient.ManualJournalsUpdateParamsDetails();
      //expect(instance).to.be.a(FreeeAccountingClient.ManualJournalsUpdateParamsDetails);
    });
