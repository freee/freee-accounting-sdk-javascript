...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.DealsDetails1();
  });
  ...
  describe('DealsDetails1', function() {
    it('should create an instance of DealsDetails1', function() {
      // uncomment below and update the code to test DealsDetails1
      //var instance = new FreeeAccountingClient.DealsDetails1();
      //expect(instance).to.be.a(FreeeAccountingClient.DealsDetails1);
    });
