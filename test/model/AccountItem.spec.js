...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.AccountItem();
  });
  ...
  describe('AccountItem', function() {
    it('should create an instance of AccountItem', function() {
      ...
      //var instance = new FreeeAccountingClient.AccountItem();
      //expect(instance).to.be.a(FreeeAccountingClient.AccountItem);
    });
