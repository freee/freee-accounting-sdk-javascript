...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FreeeAccountingClient.ManualJournalsCreateParamsDetails();
  });
  ...
  describe('ManualJournalsCreateParamsDetails', function() {
    it('should create an instance of ManualJournalsCreateParamsDetails', function() {
      // uncomment below and update the code to test ManualJournalsCreateParamsDetails
      //var instance = new FreeeAccountingClient.ManualJournalsCreateParamsDetails();
      //expect(instance).to.be.a(FreeeAccountingClient.ManualJournalsCreateParamsDetails);
    });
