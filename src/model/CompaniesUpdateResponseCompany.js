...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FiscalYears'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./FiscalYears'));
  } else {
    // Browser globals (root is window)
    if (!root.FreeeAccountingClient) {
      root.FreeeAccountingClient = {};
    }
    root.FreeeAccountingClient.CompaniesUpdateResponseCompany = factory(root.FreeeAccountingClient.ApiClient, root.FreeeAccountingClient.FiscalYears);
  }
}(this, function(ApiClient, FiscalYears) {
  'use strict';
  ...
  /**
   * The CompaniesUpdateResponseCompany model module.
   * @module model/CompaniesUpdateResponseCompany
   * @version v0.0.1
   */

  /**
   * Constructs a new <code>CompaniesUpdateResponseCompany</code>.
   * @alias module:model/CompaniesUpdateResponseCompany
   * @class
   ...
   * @param txnNumberFormat {module:model/CompaniesUpdateResponseCompany.TxnNumberFormatEnum} 仕訳番号形式（not_used: 使用しない、digits: 数字（例：5091824）、alnum: 英数字（例：59J0P））
   * @param privateSettlement {Boolean} プライベート資金/役員資金（false: 使用しない、true: 使用する）
   * @param minusFormat {Number} マイナスの表示方法（0: -、 1: △）
   * @param role {module:model/CompaniesUpdateResponseCompany.RoleEnum} ユーザーの権限
   ...
   * @param industryClass {module:model/CompaniesUpdateResponseCompany.IndustryClassEnum} 種別（agriculture_forestry_fisheries_ore: 農林水産業/鉱業、construction: 建設、manufacturing_processing: 製造/加工、it: IT、transportation_logistics: 運輸/物流、retail_wholesale: 小売/卸売、finance_insurance: 金融/保険、real_estate_rental: 不動産/レンタル、profession: 士業/学術/専門技術サービス、design_production: デザイン/制作、food: 飲食、leisure_entertainment: レジャー/娯楽、lifestyle: 生活関連サービス、education: 教育/学習支援、medical_welfare: 医療/福祉、other_services: その他サービス、other: その他）
   * @param industryCode {module:model/CompaniesUpdateResponseCompany.IndustryCodeEnum} コード（transport_delivery: 輸送業/配送業、delivery: バイク便等の配達業、other_transportation_logistics: その他の運輸業、物流業）
   * @param workflowSetting {module:model/CompaniesUpdateResponseCompany.WorkflowSettingEnum} 仕訳承認フロー（enable: 有効、 disable: 無効）
   */
  ...
  /**
   * Constructs a <code>CompaniesUpdateResponseCompany</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompaniesUpdateResponseCompany} obj Optional instance to populate.
   * @return {module:model/CompaniesUpdateResponseCompany} The populated <code>CompaniesUpdateResponseCompany</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('fiscal_years')) {
        obj['fiscal_years'] = ApiClient.convertToType(data['fiscal_years'], [FiscalYears]);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/CompaniesUpdateResponseCompany.TxnNumberFormatEnum} txn_number_format
   */
  ...
  /**
   * ユーザーの権限
   * @member {module:model/CompaniesUpdateResponseCompany.RoleEnum} role
   */
  ...
  /**
   * 種別（agriculture_forestry_fisheries_ore: 農林水産業/鉱業、construction: 建設、manufacturing_processing: 製造/加工、it: IT、transportation_logistics: 運輸/物流、retail_wholesale: 小売/卸売、finance_insurance: 金融/保険、real_estate_rental: 不動産/レンタル、profession: 士業/学術/専門技術サービス、design_production: デザイン/制作、food: 飲食、leisure_entertainment: レジャー/娯楽、lifestyle: 生活関連サービス、education: 教育/学習支援、medical_welfare: 医療/福祉、other_services: その他サービス、other: その他）
   * @member {module:model/CompaniesUpdateResponseCompany.IndustryClassEnum} industry_class
   */
   ...
   * @member {module:model/CompaniesUpdateResponseCompany.IndustryCodeEnum} industry_code
   */
  exports.prototype['industry_code'] = undefined;
  /**
   * 仕訳承認フロー（enable: 有効、 disable: 無効）
   * @member {module:model/CompaniesUpdateResponseCompany.WorkflowSettingEnum} workflow_setting
   */
  exports.prototype['workflow_setting'] = undefined;
  /**
   * @member {Array.<module:model/FiscalYears>} fiscal_years
   */
  exports.prototype['fiscal_years'] = undefined;
