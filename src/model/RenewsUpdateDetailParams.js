...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FreeeAccountingClient.RenewsUpdateDetailParams = factory(root.FreeeAccountingClient.ApiClient);
  }
  ...
  /**
   * The RenewsUpdateDetailParams model module.
   * @module model/RenewsUpdateDetailParams
   * @version v0.0.1
   */

  /**
   * Constructs a new <code>RenewsUpdateDetailParams</code>.
   * @alias module:model/RenewsUpdateDetailParams
   * @class
  ...
  /**
   * Constructs a <code>RenewsUpdateDetailParams</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RenewsUpdateDetailParams} obj Optional instance to populate.
   * @return {module:model/RenewsUpdateDetailParams} The populated <code>RenewsUpdateDetailParams</code> instance.
   */
