...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FreeeAccountingClient.DealsidDetails = factory(root.FreeeAccountingClient.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>DealsidDetails</code>.
   * @alias module:model/DealsidDetails
   * @class
  ...
  /**
   * Constructs a <code>DealsidDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DealsidDetails} obj Optional instance to populate.
   * @return {module:model/DealsidDetails} The populated <code>DealsidDetails</code> instance.
   */
