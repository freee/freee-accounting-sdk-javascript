...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DealsDetails', 'model/DealsPayments'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DealsDetails'), require('./DealsPayments'));
  } else {
    // Browser globals (root is window)
    if (!root.FreeeAccountingClient) {
      root.FreeeAccountingClient = {};
    }
    root.FreeeAccountingClient.DealsWithoutRenews = factory(root.FreeeAccountingClient.ApiClient, root.FreeeAccountingClient.DealsDetails, root.FreeeAccountingClient.DealsPayments);
  }
}(this, function(ApiClient, DealsDetails, DealsPayments) {
  'use strict';
  ...
  /**
   * Constructs a new <code>DealsWithoutRenews</code>.
   * @alias module:model/DealsWithoutRenews
   * @class
  ...
  /**
   * Constructs a <code>DealsWithoutRenews</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DealsWithoutRenews} obj Optional instance to populate.
   * @return {module:model/DealsWithoutRenews} The populated <code>DealsWithoutRenews</code> instance.
   */
   ...
   * @member {module:model/DealsWithoutRenews.TypeEnum} type
   */
