...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FreeeAccountingClient.ManualJournalsUpdateParamsDetails = factory(root.FreeeAccountingClient.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>ManualJournalsUpdateParamsDetails</code>.
   * 貸借行一覧（配列）: 貸借合わせて100行まで登録できます。
   * @alias module:model/ManualJournalsUpdateParamsDetails
   * @class
   * @param entrySide {module:model/ManualJournalsUpdateParamsDetails.EntrySideEnum} 貸借（貸方: credit, 借方: debit）
  ...
  /**
   * Constructs a <code>ManualJournalsUpdateParamsDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ManualJournalsUpdateParamsDetails} obj Optional instance to populate.
   * @return {module:model/ManualJournalsUpdateParamsDetails} The populated <code>ManualJournalsUpdateParamsDetails</code> instance.
   */
   ...
   * @member {module:model/ManualJournalsUpdateParamsDetails.EntrySideEnum} entry_side
   */
