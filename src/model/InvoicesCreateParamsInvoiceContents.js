...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FreeeAccountingClient.InvoicesCreateParamsInvoiceContents = factory(root.FreeeAccountingClient.ApiClient);
  }
  ...
  /**
   * The InvoicesCreateParamsInvoiceContents model module.
   * @module model/InvoicesCreateParamsInvoiceContents
   * @version v0.0.1
   */

  /**
   * Constructs a new <code>InvoicesCreateParamsInvoiceContents</code>.
   * @alias module:model/InvoicesCreateParamsInvoiceContents
   * @class
   * @param order {Number} 順序
   * @param type {module:model/InvoicesCreateParamsInvoiceContents.TypeEnum} 行の種類
   */
  ...
  /**
   * Constructs a <code>InvoicesCreateParamsInvoiceContents</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoicesCreateParamsInvoiceContents} obj Optional instance to populate.
   * @return {module:model/InvoicesCreateParamsInvoiceContents} The populated <code>InvoicesCreateParamsInvoiceContents</code> instance.
   */
  ...
  /**
   * 行の種類
   * @member {module:model/InvoicesCreateParamsInvoiceContents.TypeEnum} type
   */
