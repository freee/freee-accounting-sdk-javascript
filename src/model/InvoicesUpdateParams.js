...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InvoicesUpdateParamsInvoiceContents'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InvoicesUpdateParamsInvoiceContents'));
  } else {
    // Browser globals (root is window)
    if (!root.FreeeAccountingClient) {
      root.FreeeAccountingClient = {};
    }
    root.FreeeAccountingClient.InvoicesUpdateParams = factory(root.FreeeAccountingClient.ApiClient, root.FreeeAccountingClient.InvoicesUpdateParamsInvoiceContents);
  }
}(this, function(ApiClient, InvoicesUpdateParamsInvoiceContents) {
  'use strict';
  ...
  /**
   * Constructs a new <code>InvoicesUpdateParams</code>.
   * @alias module:model/InvoicesUpdateParams
   * @class
  ...
  /**
   * Constructs a <code>InvoicesUpdateParams</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoicesUpdateParams} obj Optional instance to populate.
   * @return {module:model/InvoicesUpdateParams} The populated <code>InvoicesUpdateParams</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('invoice_contents')) {
        obj['invoice_contents'] = ApiClient.convertToType(data['invoice_contents'], [InvoicesUpdateParamsInvoiceContents]);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/InvoicesUpdateParams.InvoiceStatusEnum} invoice_status
   */
  ...
  /**
   * 敬称（御中、様、(空白)の3つから選択）
   * @member {module:model/InvoicesUpdateParams.PartnerTitleEnum} partner_title
   */
   ...
   * @member {module:model/InvoicesUpdateParams.PaymentTypeEnum} payment_type
   */
   ...
   * @member {module:model/InvoicesUpdateParams.UseVirtualTransferAccountEnum} use_virtual_transfer_account
   */
   ...
   * @member {module:model/InvoicesUpdateParams.InvoiceLayoutEnum} invoice_layout
   */
  exports.prototype['invoice_layout'] = undefined;
  /**
   * 請求書の消費税計算方法(inclusive: 内税表示 (デフォルト), exclusive: 外税表示)
   * @member {module:model/InvoicesUpdateParams.TaxEntryMethodEnum} tax_entry_method
   */
  exports.prototype['tax_entry_method'] = undefined;
  /**
   * 請求内容
   * @member {Array.<module:model/InvoicesUpdateParamsInvoiceContents>} invoice_contents
   */
